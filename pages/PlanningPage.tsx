...
export const PlanningPage: React.FC = () => {
    // FIX: Destructure handlePlanDelete from useDataContext
    const { equipmentTypes, maintenancePlans, handlePlanSave, handlePlanDelete, showToast, generateFullPlanning2026, handleBulkDeleteWorkOrders } = useDataContext();
...
// FIX: Corrected the page navigation in the `showToast` callback. Changed the invalid page name 'schedule' to the valid 'work_orders' to prevent a type error and ensure correct navigation.
                    onClick: () => setCurrentPage('work_orders')
                });
            }
