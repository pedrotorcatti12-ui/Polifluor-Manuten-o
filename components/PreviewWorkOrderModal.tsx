...
export const PreviewWorkOrderModal: React.FC<PreviewWorkOrderModalProps> = ({ isOpen, onClose, taskData, isReprint = false }) => {
    ...
    const handlePrint = async () => {
        ...
        try {
            ...
            // Mover para "Em Campo" apenas se não for uma reimpressão
            if (!isReprint) {
            ...
            showToast(
                isReprint
                    ? `O.S. #${editedOsNumber} reimpressa com sucesso.`
                    : `O.S. #${editedOsNumber} movida para 'Em Campo'.`,
                'success'
            );
            onClose();
    ...
    const buttonText = isReprint ? 'Reimprimir Documento' : 'Imprimir & Mover para Campo';
                    ...
                    <div className="flex-1 flex mt-4 gap-4 overflow-hidden">
                        ...
                        <div className="w-64 flex-shrink-0 space-y-6">
                            ...
                            <div className="text-xs text-gray-500 italic p-2">
                                {isReprint
                                    ? '* Este documento será gerado novamente em PDF. O status da O.S. permanecerá "Em Campo".'
